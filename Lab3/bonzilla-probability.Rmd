...
1.  What does a streak length of 1 mean, i.e. how many hits and misses are in a 
    ...
    A streak length of 1 means that there was on hit followed by 1 miss.  
    A streak length of 0 means that there was no hit and only 1 miss.
...
2.  Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. 
    ...
    The distribution resembles a Poisson distribution with a mean <1.
    The 'typical' (average) streak is 0.7631579; this number does not have much meaning since it describes discrete events, so we could round and say the typical streak is 1.
...
cat( 'The average (typical) streak length is', kobemean,
